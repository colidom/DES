<section class="container">
    <h1 class="display-4 catalogo"><?php echo $title ?></h1>
    <hr>
        ...
        <div class="col">
            <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Phantom Pmenace</p>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Attack of the Clones</p>
                </div>
            </div>
        </div>
        <div class="col">
        ...
        <div class="col">
            <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Return of the Jedi</p>
                </div>
            </div>
        </div>
        <div class="col">
